...
export const config = {
  matcher: [
    ...
    '/((?!_next/static|_next/image|favicon.ico|auth/callback|api/calendar|api/cron|api/sync-results|api/fetch-lineup|manifest\\.json|manifest\\.webmanifest|icon|apple-icon|sitemap\\.xml|robots\\.txt|privacy|terms).*)',
  ],
}
